...
import { DoanhThuMoreMenu } from '../sections/@dashboard/user';
// import DonHangMoreMenu from '../sections/@dashboard/user/DonHangMoreMenu';

export default function ItemDoanhThu(props) {
    ...
    return (
        <>
            ...
            >
                ...
                {/* --------------- mã  ----------------- */}
                <TableCell className='ma_DT' component="th" scope="row"  >
                    <Typography align='left' variant="subtitle2"  >
                        {props._id}
                    </Typography>
                </TableCell>
                {/* thông tin */}
                <TableCell className='thongTin_DT' style={{ 'paddingLeft': '10px', 'paddingRight': '0' }}>
                    <Typography align='left' variant="subtitle2"  >
                        {props.NameDH}
                    </Typography>
                    <Typography align='left' variant="subtitle2"  >
